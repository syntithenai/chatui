...
export default function MicrophoneComponent(props) {
    ...
    return  <button  id='microphone_button' onContextMenu={function(e) {e.preventDefault(); if (props.onContextMenu) {props.onContextMenu()} }} onClick={function(e) {
            e.preventDefault(); if (props.onClick) props.onClick()  }}   style={mergedStyle} >
        <div style={{position: 'relative', width:'85%', top:'0.1em', left:'0.1em'}}>
